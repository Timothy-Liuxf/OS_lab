...
/*
*	LAB 5: (3) In the TA's reference implementation, here defines funtion
...
// LAB 5: (2) you may need to define function enable_deadlock_detect here
...
void syscall()
{
	...
	case SYS_condvar_wait:
		...
		break;
	// LAB 5: (2) you may need to add case SYS_enable_deadlock_detect here
